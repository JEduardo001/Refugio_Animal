...
class setWidgetDatosPerdidos extends StatelessWidget {
  ...
  const setWidgetDatosPerdidos({
    super.key, 
    required this.image, 
    required this.nombre, 
    required this.edad,
    required this.raza,
    required this.fechaPerdido,
    required this.id,
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child:   Text('Estoy desde $fechaPerdido')
                          )
                        ],
                      )
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                   Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => administrarMascota(nombre: nombre,id: id,edad: edad,image: image, raza: raza,fecha: fechaPerdido,tipoMascota: tipoMascota,ubicacion:ubicacion)),
                    );
                  },
