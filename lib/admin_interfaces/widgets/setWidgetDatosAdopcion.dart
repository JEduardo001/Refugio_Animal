              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                   Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => administrarMascota(nombre: nombre,id: id,edad: edad,image: image, raza: raza,fecha: fechaIngreso,tipoMascota: tipoMascota,ubicacion: ubicacion)),
                    );
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    minimumSize: const Size(10.0, 30.0), // Tamaño minimo del botón
