              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                   Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => RescatarMascota(nombre: nombre,id: id,edad: edad,image: image, raza: raza,fecha: fecha,tipoMascota: tipoMascota,ubicacion:ubicacion)),
